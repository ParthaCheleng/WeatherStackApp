    ...
    return (
        <div className={cn(orbitalLoaderVariants({ messagePlacement }))}>
            <div className={cn("relative w-16 h-16", className)} {...props}>
                <motion.div
                    className="absolute inset-0 border-2 border-transparent border-t-brand-500 rounded-full"
                    animate={{ rotate: 360 }}
                    transition={{
                        duration: 1,
                ...
                />
                <motion.div
                    className="absolute inset-4 border-2 border-transparent border-t-cyan-500 rounded-full"
                    animate={{ rotate: 360 }}
                    transition={{
                        duration: 0.8,
                        repeat: Number.POSITIVE_INFINITY,
            ...
            {message && <div className="text-sm font-medium text-slate-400 mt-2">{message}</div>}
        </div>
    )
}
