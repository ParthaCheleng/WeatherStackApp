...
function ChartTooltipContent({
    ...
    return (
        <div
            className={cn(
                "border border-white/10 bg-brand-900/90 backdrop-blur-md grid min-w-[8rem] items-start gap-1.5 rounded-lg px-2.5 py-1.5 text-xs shadow-xl text-white",
                className
            )}
        >
                            ...
                            {formatter && item?.value !== undefined && item.name ? (
                                ...
                                <>
                                    ...
                                    >
                                        ...
                                        {item.value && (
                                            <span className="text-white font-mono font-medium tabular-nums ml-2">
...
function ChartLegendContent({
    ...
    return (
        <div
            className={cn(
                "flex items-center justify-center gap-4 text-slate-300",
